  ...
  return (
    <div className=" p-6 ">
      ...
      <div className=' flex justify-center items-center border-[1px] border-primary w-[139px] h-[42.63px] rounded-[10px]'>
        <Link to="/CreateUser">
          <h4 className=' text-sm text-secondary px-[17px] bg-primary  border-[1px] border-primary rounded-[15px] mr-[-8px] z-10 relative'>User</h4>
        </Link>
        <Link to="/CreateAdmin">
          <h4 className=' text-sm text-primary px-[10px] bg-secondary  border-[1px] border-primary rounded-[15px] z-0'>Admin</h4>
        </Link> 
      </div>
      ...
      <div className=" flex items-center p-[10px] border-[1px] border-primary w-[100%] h-[65px] rounded-[10px] mt-3 ">
        <input type="text" placeholder="Voter's Identification Number (Optional)" className=" w-[100%] focus-within:outline-none " />
      </div>
      ...
      <h3 className=" text-center mt-4 ">Already have an account? <Link to="/LoginUser"><span className=' ml-2 text-primary'>Log In</span></Link></h3>
    </div>
  );
}
