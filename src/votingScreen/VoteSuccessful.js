...
const VoteSuccessful = () => {
  return (
    <div className=" p-6 ">
      ...
      <h1 className=' text-4xl text-center font-Lexend font-medium'>Vote Successful</h1>
      <p className=' text-sm text-center mt-5'>
        Your vote has been successfully submitted
      </p>
      <Link to="/">
        <div className=' flex justify-center'>
          <button className='font-normal w-[80%] h-[3.3125rem] text-secondary bg-primary rounded-[0.625rem] mt-12'  >
            Done
          </button>
        </div>
      </Link>
      <div className=' flex justify-center'>
        <button className='font-normal w-[80%] h-[3.3125rem] text-primary bg-secondary rounded-[0.625rem] border-[1px] border-primary mt-4'  >
          Check Live Stat
        </button>
      </div>
    </div >
