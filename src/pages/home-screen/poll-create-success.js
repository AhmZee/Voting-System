  ...
  return (
    <div>
      ...
      <div className=' flex gap-8 '>
        ...
        <div className=" text-center p-6 m-auto w-[375px] font-Inter h-[100vh] myLS:m-0 myLS:mt-[-80px] myLS:w-[450px] ">
          ...
          <h1 className=' text-5xl text-center font-Lexend font-medium myLS:text-3xl '>Poll Created Successfully</h1>
          <Link to="/home/home-page">
            <button className=' font-normal w-[100%] h-[65px] text-secondary bg-primary rounded-[0.625rem] border-[1px] mt-24 border-primary z-10 myLS:w-[335px] '>
              Done
            </button>
          </Link>
        </div >
...
export default PollCreateSuccess;